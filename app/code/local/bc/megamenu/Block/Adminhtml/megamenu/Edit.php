 ...
 * Time: 3:02 PM
 */
class bc_megamenu_Block_Adminhtml_megamenu_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('back', array('label' => Mage::helper('megamenu')->__('back to group')));
        ...
        $this->_formScripts[] = "
				     ...
				     ".$clist.";
				      ...
				      $('menugroup').observe('change',function(){
                                ...
                                cms = $('cms');
                                order = $('parent');
                                groupurl = baseurl+'/megamenu/adminhtml_megamenu/ajax?menugroup='+group.getValue()+'&menuid='+$('menu_id').getValue();
    ...
    public function getBackUrl()
    {
        ...
        if(Mage::registry('megamenu_data')){
            $groupid = Mage::registry('megamenu_data')->getData("menugroup");
        }
