 ...
 * Time: 3:05 PM
 */
class bc_megamenu_Block_Adminhtml_megamenu_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $collections = Mage::getModel('megamenu/megamenu')->getCollection()->addFieldToFilter("menu_id",array("neq" => $this->getRequest()->getParam('id')));


        $helper = Mage::helper('megamenu');

        $statics =  Mage::getResourceModel('cms/block_collection')->load()->toOptionArray();
        $menugroup = Mage::getModel('megamenu/megamenugroup')->getCollection()->toOptionArray();
        ...
        $fieldset->addField('title', 'text', array(
            'label' => Mage::helper('megamenu')->__('Menu title'),
        ...
        $fieldset->addField('menualias', 'text', array(
            'label' => Mage::helper('megamenu')->__('Alias'),
            'required' => false,
            'name' => 'menualias',
        ));
        ...
        $fieldset->addField('menugroup', 'select', array(
            'label' => Mage::helper('megamenu')->__('Display In'),
            'required' => true,
            'size' => 10,
            'name' => 'menugroup',
            'values' => $menugroup,
        ...
        $fieldset->addField('category', 'select', array(
            'label' => Mage::helper('megamenu')->__('Select a category'),
            'required' => false,
            'size' => 10,
            'name' => 'category',
            'values' => $clist,
        ...
        $fieldset->addField('shownumproduct', 'select', array(
            'label' => Mage::helper('megamenu')->__('Show number products of Category'),
            'required' => false,
            'size' => 10,
            'name' => 'shownumproduct',
            'values' => array(
                array(
                    'value' => 0,
                    'label' => Mage::helper('megamenu')->__('Use General Setting'),
                ),
                array(
                    'value' => 1,
        ...
        $fieldset->addField('cms', 'select', array(
            'label' => Mage::helper('megamenu')->__('Select a cms Page'),
            'required' => false,
            'size' => 10,
            'name' => 'cms',
            'values' => $cmspages,
        ...
        $fieldset->addField('mega_group', 'radios', array(
            'label' => Mage::helper('megamenu')->__('Group'),
        ...
        $fieldset->addField('mega_width', 'text', array(
            'label' => Mage::helper('megamenu')->__('Submenu Width'),
            'required' => false,
            'name' => 'mega_width',
        ));
        $fieldset->addField('mega_colw', 'text', array(
            'label' => Mage::helper('megamenu')->__('Submenu Column Width'),
            'required' => false,
            'name' => 'mega_colw',
        ));
        $fieldset->addField('mega_colxw', 'textarea', array(
            'label' => Mage::helper('megamenu')->__('Submenu Column[i] Width'),
            'required' => false,
            'style'     => 'width:300px; height:100px;',
            'name' => 'mega_colxw',
        ));
        $fieldset->addField('mega_class', 'text', array(
            'label' => Mage::helper('megamenu')->__('Additional class'),
            'required' => false,
            'name' => 'mega_class',
        ));
        ...
        $fieldset->addField('mega_subcontent', 'radios', array(
            'label'     => Mage::helper('megamenu')->__('Submenu Content'),
            ...
            'value'  => '2',
            'values' => array(
                array('value'=>'1','label'=>Mage::helper('megamenu')->__('Child menu items'),'selected' => 'true'),
                array('value'=>'2','label'=>Mage::helper('megamenu')->__('Custom xml block')),
                array('value'=>'3','label'=>Mage::helper('megamenu')->__('Satic blocks')),
            ),
            'disabled' => false,
            'readonly' => false,
            'tabindex' => 0
        ...
        $fieldset->addField('staticblocks', 'multiselect', array(
            'label' => Mage::helper('megamenu')->__('Select Blocks'),
            'required' => false,
            'size' => 10,
            'name' => 'staticblocks',
            'values' => $statics,
        ...
        $fieldset->addField('contentxml', 'editor', array(
            'name'      => 'contentxml',
            'label'     => Mage::helper('megamenu')->__('Custom block xml'),
            'title'     => Mage::helper('megamenu')->__('Custom block xml'),
